...
def main(argv):
    ...
    parser.add_argument('--un', '-un', help="Файл с необработанными строками лога, default = unknown_result.txt", type=str,
                        default='unknown_result.txt')
    parser.add_argument('--o', '-o', help="Обработанный файл формата Время - Ток, default = result.txt", type=str, default='result.txt')
    ...
    parser.add_argument('--intens', '-intens', help="Интенсивность облучения в рентген/сек, default = 112", type=float,
                        default=112)
    parser.add_argument('--oimg', '-oimg', help="Сохраняет график в файл, default = plot.png", type=str, default='plot.png')
    parser.add_argument('--dname', '-dname', help="Название образца на легенде, default = Образец 1", type=str, default='Образец 1')
